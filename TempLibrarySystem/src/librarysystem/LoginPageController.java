...
public class LoginPageController extends Switchable implements Initializable,PawPrintKeepAndDelete {
    ...
    String message = "This application create a library manage system.\n" +
    "Students can search books from the database to check if there are enough copies in the library. \n" +
    "Then students can borrow books and return them. The system can record the number of books borrowed by a student. \n" +
    "If a book is borrowed, the database will refresh and record. The system can show how many books this student borrowed and the books' names.\n" +
